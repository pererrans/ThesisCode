...
orderOfFirms = repmat([3 1 2],1,ceil((T+1)/numFirms));  %HARDCODE ALERT
...
saveas(fig, '1_production path.jpg'); 
...
ylabel('NPV');
hold off
saveas(fig, '1_NPV comparison.jpg'); 
...
for varywho = 1:numFirms
    ...
    saveas(fig,  sprintf( '1_NPV_variations %s.jpg', firmNames(varywho)) ); 
end
...
saveas(fig, [pwd '2_production path.jpg']); 
...
ylabel('NPV');
hold off
saveas(fig, '2_NPV comparison.jpg'); 
...
for varywho = 1:numFirms
    ...
    saveas(fig,  sprintf( '2_NPV_variations %s.jpg', firmNames(varywho)) ); 
end
...
saveas(fig, '3_production path.jpg'); 
...
ylabel('NPV');
hold off
saveas(fig, '3_NPV comparison.jpg'); 
...
for varywho = 1:numFirms
    ...
    saveas(fig,  sprintf( '3_NPV_variations %s.jpg', firmNames(varywho)) ); 
end
...
%specify the order that the firms will make decision in. 2 in period t
%indicates that firm 2 will make a decision in t=2
orderOfFirms = repmat([2 3 1],1,ceil((T+1)/numFirms));  %HARDCODE ALERT
orderOfFirms = orderOfFirms(1:T+1);
...
saveas(fig, '4_production path.jpg'); 
...
ylabel('NPV');
hold off
saveas(fig, '4_NPV comparison.jpg'); 
...
for varywho = 1:numFirms
    ...
    saveas(fig,  sprintf( '4_NPV_variations %s.jpg', firmNames(varywho)) ); 
end
