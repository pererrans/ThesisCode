...
% is numIncMines+1
Va_actions = zeros(2,2,2,2,2,2,2,2,2,numFirms,5,4,numIncMines+1, T+1); 
Vb_actions = zeros(2,2,2,2,2,2,2,2,2,numFirms,5,4,numIncMines+1, T+1);
Vc_actions = zeros(2,2,2,2,2,2,2,2,2,numFirms,5,4,numIncMines+1, T+1);
